...
public class RuleNotFoundException extends WebApplicationException implements Serializable {
    ...
    public RuleNotFoundException(String msg, Exception e) {
        super(msg, e);
    }

    @Override
    public Response getResponse() {
        return Response.status(404).build();    // Forbidden
    }
